...
func (r *mutationResolver) UpdateRequest(ctx context.Context, input ent.UpdateRequestInput) (*ent.Request, error) {
	panic(fmt.Errorf("not implemented"))
}
...
func (r *mutationResolver) UpdateSession(ctx context.Context, input ent.UpdateSessionInput) (*ent.Session, error) {
	panic(fmt.Errorf("not implemented"))
}
