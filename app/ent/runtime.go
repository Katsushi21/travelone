...
import (
	...
	"github.com/Katsushi21/travelone/ent/schema"
...
func init() {
	...
	friendDescCreatedAt := friendMixinFields1[0].Descriptor()
	...
	friendDescUpdatedAt := friendMixinFields1[1].Descriptor()
	...
	muteDescUpdatedAt := muteMixinFields1[1].Descriptor()
	...
	muteDescID := muteMixinFields0[0].Descriptor()
	...
	requestDescCreatedAt := requestMixinFields1[0].Descriptor()
	...
	requestDescUpdatedAt := requestMixinFields1[1].Descriptor()
	...
	requestDescID := requestMixinFields0[0].Descriptor()
