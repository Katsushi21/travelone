...
func (lq *LikeQuery) QueryAccount() *AccountQuery {
	query := &AccountQuery{config: lq.config}
...
func (lq *LikeQuery) WithAccount(opts ...func(*AccountQuery)) *LikeQuery {
	query := &AccountQuery{config: lq.config}
...
func (lq *LikeQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Like, error) {
	...
	if query := lq.withAccount; query != nil {
		if err := lq.loadAccount(ctx, query, nodes, nil,
			func(n *Like, e *Account) { n.Edges.Account = e }); err != nil {
			return nil, err
		}
	}
...
func (lq *LikeQuery) loadAccount(ctx context.Context, query *AccountQuery, nodes []*Like, init func(*Like), assign func(*Like, *Account)) error {
