...
func (au *AccountUpdate) AddSessionIDs(ids ...uuid.UUID) *AccountUpdate {
...
func (au *AccountUpdate) RemoveSessionIDs(ids ...uuid.UUID) *AccountUpdate {
...
// AddSessionIDs adds the "session" edge to the Session entity by IDs.
func (auo *AccountUpdateOne) AddSessionIDs(ids ...uuid.UUID) *AccountUpdateOne {
...
// RemoveSessionIDs removes the "session" edge to Session entities by IDs.
func (auo *AccountUpdateOne) RemoveSessionIDs(ids ...uuid.UUID) *AccountUpdateOne {
