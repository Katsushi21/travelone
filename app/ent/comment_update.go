...
func (cu *CommentUpdate) SetAccountID(u uuid.UUID) *CommentUpdate {
...
func (cu *CommentUpdate) SetAccount(a *Account) *CommentUpdate {
...
func (cu *CommentUpdate) check() error {
	...
	if _, ok := cu.mutation.AccountID(); cu.mutation.AccountCleared() && !ok {
		return errors.New(`ent: clearing a required unique edge "Comment.account"`)
	}
	return nil
}
...
// SetAccountID sets the "account_id" field.
func (cuo *CommentUpdateOne) SetAccountID(u uuid.UUID) *CommentUpdateOne {
...
// SetAccount sets the "account" edge to the Account entity.
func (cuo *CommentUpdateOne) SetAccount(a *Account) *CommentUpdateOne {
